            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="{{ url('/') }}" class="waves-effect">
                        <i class="icon-accelerator"></i><span class="badge badge-success badge-pill float-right"></span>
                        <span> Dashboard
                        </span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ url('mahasiswa') }}" class="waves-effect"><i class="icon-mail-open"></i><span>
                            Data Mahasiswa
                        </span></a>
                </li>
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="icon-share"></i><span> Multi
                            Level <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span>
                        </span></a>
                    <ul class="submenu">
